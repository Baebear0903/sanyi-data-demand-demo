...
export const config: AppConfig = {
     ...
     * 1.9.0：业务页面文案全面去方案化——下线直接指称建设方案 / 原文、模块映射注解、
     *        方案条款号后缀、演示导览与实现口径、演示环境元叙述等 8 类说明性文案；
     *        roleMatrix 删除「职责依据」列（原为建设方案条款引用），RoleMatrixRow 同步去掉 spec。
     */
    version: '1.9.0',
    appName: '数据需求管理',
    ...
    /* ---------------- 角色职责矩阵（14 类，用于系统配置页展示） ---------------- */
    roleMatrix: [
      { name: '用数方（需求方）', org: '三医部门 / 医疗机构 / 委办局', duty: '提需求、查进度、撤回、验收、评价' },
      { name: '供数方（资源归属方）', org: '资源归属单位', duty: '审批订阅与需求、反馈评价' },
      { name: '数据资源生产者 / 发布人', org: '数据生产部门', duty: '资源配置、提交发布申请、撤单' },
      { name: '数据资源管理人员', org: '数据资源管理处', duty: '审核发布申请、逐级审批' },
      { name: '服务台受理员', org: '服务台', duty: '统一受理、登记、分派、监督通知、回访' },
      { name: '一线运维', org: '运维中心一线组', duty: '事件处理、知识调用、一线解决' },
      { name: '二线 / 专家组', org: '运维中心二线组', duty: '根因分析、已知错误管理、决策树分析' },
      { name: '生产实施方', org: '数据生产部门', duty: '采集 / 加工 / 建模任务实施' },
      { name: '变更审批人', org: '领导小组办公室', duty: '审批规则定义、多级审批、会签' },
      { name: '多级安全审批人', org: '安全管理部门', duty: '敏感数据临时授权工单逐级审批（系统/邮件）' },
      { name: '发布管理员', org: '运维管理', duty: '发布申请、发布包归档、回滚、发布审计' },
      { name: '知识库维护责任人', org: '各业务领域', duty: '知识创建审核发布撤回、评论处理' },
      { name: '平台 / 租户 / 项目管理员', org: '平台运营中心', duty: '租户、应用、服务代理、密钥、渠道授权' },
      { name: '管理层 / 决策层', org: '三医联动领导小组', duty: '统计分析、服务概况、事件统计报表' },
    ],
